...
class ContractFacts:
    ...
    max_damages_ratio: float | None = None
    combined_liability_ratio: float | None = None
    liability_cap_hkd: float | None = None
    has_warranty_clause: bool = False
    warranty_has_shot_limit: bool = False
    warranty_has_time_limit: bool = False
    warranty_first_expiry_applies: bool = False
    replacement_warranty_resets: bool = False
    sales_country_compliance_shifted: bool = False
    ip_license_present: bool = False
    ip_license_purpose_limited: bool = False
    ip_license_term_limited: bool = False
    ip_license_royalty_free: bool = False
    ip_license_non_transferable: bool = False
    currency: str = "CNY"
    language: str = "zh"
