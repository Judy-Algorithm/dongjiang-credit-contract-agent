...
import {customerType, dateTime, escapeHtml, statusClass} from "../format.js?v=20260807-contract-approval"

const pendingStatuses = new Set([
  "credit_pending_approval","credit_supplement_required",
  "awaiting_contract","blocked","pending_special_approval","pending_manual_review","pending_legal_approval",
])
const approvalStatuses = new Set([
  "credit_pending_approval","pending_special_approval","pending_manual_review","pending_legal_approval",
])
  ...
  root.innerHTML = `
    ...
    <section class="panel toolbar">
      ...
      <select id="statusFilter">
        ...
        <option value="pending_legal_approval">等待合同法务批准</option>
